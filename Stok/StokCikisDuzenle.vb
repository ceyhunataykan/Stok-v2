Public Class StokCikisDuzenle
    ...
    End Sub
    Private Sub btnListeEkle_Click_1(sender As Object, e As EventArgs) Handles btnListeEkle.Click
        ...
        listeGetir()
    End Sub
    Private Sub btnSil_Click_1(sender As Object, e As EventArgs) Handles btnSil.Click
        ...
        listeGetir()
    End Sub
    Private Sub btnStokKart_Click_1(sender As Object, e As EventArgs) Handles btnStokKart.Click
        gizleSec = True
        cikisDuzenle = True
        StokKart.Show()
    End Sub
    Private Sub nudMiktar_ValueChanged_1(sender As Object, e As EventArgs) Handles nudMiktar.ValueChanged
    ...
    End Sub
    Private Sub btnIptal_Click_1(sender As Object, e As EventArgs) Handles btnIptal.Click
        Me.Close()
    End Sub

    Private Sub StokCikisDuzenle_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
