...
Partial Public Class StokEntities
    ...
    Public Overridable Property Cari() As DbSet(Of Cari)
    Public Overridable Property Cari_Detay() As DbSet(Of Cari_Detay)
    Public Overridable Property Depo() As DbSet(Of Depo)
    Public Overridable Property Fatura() As DbSet(Of Fatura)
    Public Overridable Property Fatura_Detay() As DbSet(Of Fatura_Detay)
